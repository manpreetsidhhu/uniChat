...
<head>
    ...
    <style>
        ...
        .emoji-picker{position:absolute;bottom:45px;right:0;background:white;border:1px solid #ddd;border-radius:5px;padding:5px;box-shadow:0 2px 5px rgba(0,0,0,0.1);display:none}
        .emoji-picker.active{display:flex}
        .emoji-item{cursor:pointer;font-size:20px;padding:5px}
        
        /* Extra options popup styling */
        .extra-options-btn{padding:10px;background:none;border:none;cursor:pointer;color:#6366f1;transition:all 0.2s;border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center}
        .extra-options-btn:hover{background:#f3f4f6}
        .extra-options-popup{position:fixed;bottom:120px;background:white;border-radius:8px;box-shadow:0 3px 10px rgba(0,0,0,0.1);display:none;z-index:100;overflow:hidden;min-width:150px}
        .extra-options-popup.active{display:block;animation:fadeIn 0.2s ease-out}
        .popup-option{display:flex;align-items:center;width:100%;text-align:left;padding:10px 15px;background:none;border:none;cursor:pointer;color:#4b5563;transition:all 0.2s}
        .popup-option:hover{background:#f3f4f6}
        .popup-option i{margin-right:8px;width:16px}
        ...
        .user-item { transition: all 0.2s ease; }
        .user-item:hover { transform: translateX(5px); }
        ...
        .message-send { animation: sendMessage 0.3s ease-out; }
    </style>
</head>
